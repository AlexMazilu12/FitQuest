package com.fontys.fitquest.configuration.auth;
...
public class AuthenticationRequestFilter extends OncePerRequestFilter {
    ...
    private void setupSpringSecurityContext(AccessToken accessToken) {
        UserDetails userDetails = org.springframework.security.core.userdetails.User.withUsername(accessToken.getEmail())
                .password("")
                .authorities(new SimpleGrantedAuthority(SPRING_SECURITY_ROLE_PREFIX + accessToken.getRole()))
                .build();
