...
class AuthenticationRequestFilterTest {
    ...
    @Test
    void doFilterInternal_validToken() throws ServletException, IOException, Exception {
    ...
    @Test
    void doFilterInternal_invalidToken() throws ServletException, IOException, Exception {
    ...
    @Test
    void doFilterInternal_noToken() throws ServletException, IOException, Exception {
